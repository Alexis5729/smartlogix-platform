...
import { createShipment, getShipments, deleteShipment } from "../api/shipmentApi";
...
function ShipmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-cyan-50 p-8">
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-black text-slate-900 mb-2">Envíos</h1>
        <p className="text-slate-500 text-lg">Gestión de envíos conectada al shipment-service.</p>
      </div>
